...
import 'package:rakesh_s_application2/widgets/custom_outlined_button.dart';
import 'package:rakesh_s_application2/widgets/custom_text_form_field.dart';
import 'package:rakesh_s_application2/domain/googleauth/google_auth_helper.dart';
  ...
  Widget _buildInputField(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          BlocSelector<SignUpCreateAcountBloc, SignUpCreateAcountState,
