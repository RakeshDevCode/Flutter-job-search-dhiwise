...
import 'package:rakesh_s_application2/presentation/apply_job_popup_dialog/apply_job_popup_dialog.dart';
  ...
  Widget _buildInputField1(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          BlocSelector<ApplyJobBloc, ApplyJobState, TextEditingController?>(
