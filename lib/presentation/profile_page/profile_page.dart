              ...
              builder: (context, profileModelObj) {
                return Wrap(
                    ...
                    children: List<Widget>.generate(
                        profileModelObj?.fortysevenItemList.length ?? 0,
                        (index) {
                      FortysevenItemModel model =
                          profileModelObj?.fortysevenItemList[index] ??
                              FortysevenItemModel();
                      return FortysevenItemWidget(model,
                          onSelectedChipView: (value) {
                        context.read<ProfileBloc>().add(UpdateChipViewEvent(
