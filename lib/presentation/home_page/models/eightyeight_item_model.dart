import 'fulltime3_item_model.dart';
...
class EightyeightItemModel {
  EightyeightItemModel({
    ...
    this.motorola,
    this.price,
    this.fulltime3ItemList,
    this.id,
  }) {
    digitalMarketing = digitalMarketing ?? "Digital Marketing";
    motorola = motorola ?? "Motorola";
    price = price ?? "560 - 12.000/Month";
    fulltime3ItemList =
        fulltime3ItemList ?? List.generate(2, (index) => Fulltime3ItemModel());
    id = id ?? "";
  }
